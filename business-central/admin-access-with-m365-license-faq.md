...
---
# FAQ sur l’accès avec les licences Microsoft 365
...
### Puis-je configurer de manière proactive différentes autorisations de démarrage pour différents groupes d’utilisateurs ?
...
### Puis-je configurer de manière proactive les autorisations, les profils et les paramètres des utilisateurs individuels avant qu’ils ne se connectent ?
...
### Une fois qu’un utilisateur s’est connecté, puis-je modifier les objets auxquels il a accès ?
...
### Comment empêcher l’accès aux tables sensibles ?
...
### Au lieu de personnaliser la configuration de la licence, puis-je personnaliser un groupe d’utilisateurs ?
...
### Quand un utilisateur de Business Central partage un enregistrement dans Teams, accorde-t-il de nouvelles autorisations ?
...
### Cette fonctionnalité prend-elle en charge la sécurité au niveau des lignes ?
...
### Si je configure des autorisations incluant un accès en écriture, les utilisateurs pourront-ils écrire dans Teams ?
...
### Pourquoi le paramètre d’activation de l’accès n’est-il pas disponible pour mon environnement ?
...
### Puis-je accéder à Business Central localement avec des licences Microsoft 365 ?
...
### Quel est le profil de l’employé ?
...
### Qu’est-ce que le groupe d’utilisateurs Teams Users ?
...
### Les utilisateurs qui n’ont qu’une licence Microsoft 365 s’affichent-ils dans la liste des utilisateurs dans Business Central ?
...
### Cette fonctionnalité fonctionne-t-elle pour les solutions ISV intégrées ?
...
### Un client peut-il utiliser cette fonctionnalité s’il ne dispose pas de Business Central ?
...
### Comment cela m’aide-t-il à gérer les coûts d’abonnement dans mon organisation ?
...
### La liste des licences dans Business Central affiche une licence Microsoft 365. Qu’est-ce-que c’est ?
...
### Dois-je acquérir un nouveau type de licence Microsoft 365 pour que cette fonctionnalité fonctionne ?  
...
### Comment savoir quels utilisateurs n’ont qu’une licence Microsoft 365 ?
...
### Comment filtrer la liste des utilisateurs dans Business Central pour voir les utilisateurs qui n’ont qu’une licence Microsoft 365 ?
...
### Qu’en est-il des utilisateurs qui possèdent à la fois une licence Microsoft 365 et une licence Business Central ?
...
### Cette licence est-elle liée à la licence de membre de l’équipe Business Central ?
...
### Business Central applique-t-il l’une des contraintes ?
...
### Puis-je accéder aux enregistrements sur Teams pour iOS et Teams pour Android ? 
...
### Comment les utilisateurs modifient-ils leurs paramètres personnels dans Mes paramètres ? 
...
### Qu’est-ce qui détermine le choix de la langue quand vous vous connectez pour la première fois ? 
...
### Pourquoi ne puis-je pas activer certains des liens colorés dans les onglets et les détails de la carte ?
...
### Pourquoi ne puis-je pas activer les actions de notification de page ?
...
### Les utilisateurs Microsoft 365 peuvent-ils supprimer des onglets ?
...
### Si je ne peux pas filtrer, verrai-je toujours une liste filtrée créée par d’autres ?
