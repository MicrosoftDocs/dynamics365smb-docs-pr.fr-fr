...
ms.author: bholtorf
---
# <a name="the-late-payment-prediction-extension"></a><a name="the-late-payment-prediction-extension"></a><a name="the-late-payment-prediction-extension"></a>Extension Prévisions de retard de paiement
...
## <a name="viewing-all-payment-predictions"></a><a name="viewing-all-payment-predictions"></a><a name="viewing-all-payment-predictions"></a>Affichage de toutes les prévisions de paiement
...
## <a name="viewing-a-payment-prediction-for-a-specific-sales-document"></a><a name="viewing-a-payment-prediction-for-a-specific-sales-document"></a><a name="viewing-a-payment-prediction-for-a-specific-sales-document"></a>Affichage d’une prévision de paiement pour un document vente spécifique
...
## <a name="design-details"></a><a name="design-details"></a><a name="design-details"></a>Détails de conception
...
### <a name="data-required-to-train-and-evaluate-the-model"></a><a name="data-required-to-train-and-evaluate-the-model"></a><a name="data-required-to-train-and-evaluate-the-model"></a>Données nécessaires pour former et évaluer le modèle
...
### <a name="standard-model-and-my-model"></a><a name="standard-model-and-my-model"></a><a name="standard-model-and-my-model"></a>Modèle standard et Mon modèle
...
#### <a name="to-train-and-use-your-model"></a><a name="to-train-and-use-your-model"></a><a name="to-train-and-use-your-model"></a>Pour former et utiliser votre modèle
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/predict-late-payments-sales-documents/) associée
