...
Vous pouvez également prévoir des retards de paiement par avance. Sur les fenêtres **Devis**, **Commandes vente**, et **Factures vente**, vous pouvez utiliser l'action **Prévoir le paiement** pour générer des prévisions pour le document vente que vous visualisez.
