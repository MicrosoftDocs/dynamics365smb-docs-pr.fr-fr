...
ms.author: edupont
---
# Configurer la validation des transactions intersociétés
...
## Pour configurer une société pour les transactions intersociétés
...
## Pour paramétrer les partenaires intersociétés
...
## Pour paramétrer des fournisseurs et des clients intersociétés
...
## Pour configurer le plan comptable intersociété
...
### Pour configurer le plan comptable intersociétés
...
### Pour exporter un plan comptable intersociété
...
### Pour importer le plan comptable intersociétés  
...
### Pour associer le plan comptable intersociétés au plan comptable de votre société  
...
## Pour configurer des comptes généraux par défaut des partenaires intersociétés  
...
## Pour configurer des comptabilisations intersociétés
...
### Pour définir les axes analytiques intersociétés
...
### Pour importer les axes analytiques intersociétés  
...
### Pour associer les axes analytiques intersociétés aux axes de votre société
...
8. Pour chaque axe analytique intersociété qui n’est pas associé automatiquement, renseignez le champ **Code section analytique axe IC à faire correspondre**.
