...
## <a name="flushing-production-components-in-a-advanced-warehouse-configuration"></a>Consommer les composants pour la fabrication dans une configuration entrepôt avancée
