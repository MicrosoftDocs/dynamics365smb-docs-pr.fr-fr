...
## <a name="connecting-with-trading-partners"></a>Connexion avec des partenaires commerciaux
...
## <a name="to-connect-to-the-business-central-integration-app-on-tradeshift"></a>Pour se connecter à l’application d’intégration de Business Central sur Tradeshift
...
## <a name="to-connect-to-a-document-exchange-service"></a>Se connecter à un service d’échange de document
...
## <a name="settings-for-business-central-on-premises"></a>Paramètres de Business Central local
