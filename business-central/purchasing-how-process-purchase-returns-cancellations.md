...
8. Sélectionnez le bouton **OK** pour copier les lignes dans le nouveau document.  
    ...
    -   Si le document copié est une facture ou un avoir validé, le prix unitaire, les remises facture et les remises ligne sont copiées à partir de la ligne document validée.  
