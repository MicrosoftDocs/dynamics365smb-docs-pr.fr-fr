...
---
# Paramétrage du contrôle de gestion

Avant d’utiliser la comptabilité analytique, vous devez effectuer des tâches de paramétrage.

## Soldes entre le type de coût, un centre de coûts et les coûts associés
...
## Configuration de types de coûts
...
### Pour transférer le plan comptable général vers le plan des types de coûts
...
### Types de coûts sans relation avec la comptabilité générale
...
### Pour transférer des sections analytiques de la comptabilité vers le plan des centres de coûts.
...
## Configuration des coûts associés
...
### Pour transférer des sections analytiques depuis la comptabilité vers le plan comptable des coûts associés
...
### Pour créer de nouveaux coûts associés sur la page Plan comptable des coûts associés
