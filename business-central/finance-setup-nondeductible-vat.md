...
# <a name="set-up-non-deductible-vat" />Paramétrer la TVA non déductible
...
## <a name="use-non-deductible-vat" />Utilisation de la TVA non déductible
...
## <a name="use-the-non-deductible-vat-percentage" />Utiliser le pourcentage de TVA non déductible
