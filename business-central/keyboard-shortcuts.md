...
| <kbd>Page suivante</kbd><br /><br />(<kbd>Fn</kbd>+<kbd>Flèche vers le haut</kbd>) | Faites défiler pour afficher l’ensemble de lignes sous des lignes actuelles de la vue. | Faites défiler pour afficher l’ensemble de vignettes sous des vignettes actuelles de la vue. |
| <kbd>Flèche vers le haut</kbd> | Accédez au champ de la ligne du dessous au sein de la même colonne | Accédez au champ de la vignette du dessous au sein de la même colonne |
...
|<kbd>Ctrl</kbd>+<kbd>Flèche vers le haut</kbd><br /><br />(<kbd>Ctrl</kbd>+<kbd>Cmd</kbd>+<kbd>Flèche vers le haut</kbd>)|Déplacez le focus sur la ligne suivante et conservez la ligne actuelle sélectionnée.|Non applicable.|
|<kbd>Ctrl</kbd>+<kbd>Barre d’espace</kbd><br /><br />(<kbd>Ctrl</kbd>+<kbd>Cmd</kbd>+Espace)|Étendez la sélection des lignes pour inclure la ligne active.<br /><br />Vous pouvez utiliser cette action à l’aide de <kbd>Ctrl</kbd>+<kbd>Flèche vers le haut</kbd> ou <kbd>Ctrl</kbd>+<kbd>Flèche vers le haut</kbd> pour développer votre sélection.|Non applicable.|
...
|<kbd>Maj</kbd>+<kbd>Flèche vers le haut</kbd>|Étendez la sélection des lignes pour inclure la ligne suivante.|Non applicable.|
...
|<kbd>Ctrl</kbd>+<kbd>Entrée</kbd>|Enregistrer et fermer la page.|
|<kbd>Ctrl</kbd>+<kbd>Flèche vers le haut</kbd>|Ouvrez le nouvel enregistrement pour une entité.|
...
## <a name="calendarshortcuts"></a> Raccourcis clavier du calendrier (sélecteur de date)
...
|<kbd>Ctrl</kbd>+<kbd>Flèche vers le haut</kbd><br /><br />(<kbd>Cmd</kbd>+<kbd>Flèche vers le haut</kbd>)|Accéder à la semaine suivante, le même jour de la semaine.|
...
## <a name="reportpreviewshortcuts"></a>Raccourcis clavier dans l’aperçu des états

|Sélectionnez ces touches<br />(dans macOS)|Pour|
|--------------------------------|----------|
|<kbd>Flèche vers le haut</kbd>|Faites défiler vers le bas de la page.|  
...
|<kbd>Ctrl</kbd>+<kbd>Fin</kbd><br /><br />(<kbd>Cmd</kbd>+<kbd>Début</kbd>)|Accédez à la dernière page de l’état.|
...
## <a name="zoomshortcuts"></a>Raccourcis clavier pour le zoom avant et arrière
...
## <a name="roleexplorer"></a>Raccourcis clavier pour l’explorateur de rôles
...
|<kbd>F3</kbd> ou <kbd>Ctrl</kbd>+<kbd>Flèche vers le haut</kbd>|Déplace le focus sur la fonction suivante trouvée dans l’explorateur de rôles. <kbd>F3</kbd> déplacera le focus sur la zone **Rechercher** après la dernière fonction trouvée.|
...
##  <a name="keypad"></a> Raccourcis du pavé numérique
