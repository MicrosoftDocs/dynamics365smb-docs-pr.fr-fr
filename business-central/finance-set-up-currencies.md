...
ms.locfileid: "9074899"
---
# <a name="set-up-currencies"></a>Configurer des devises

[!INCLUDE [finance-currencies-def](includes/finance-currencies-def.md)]

Utilisez un service externe pour obtenir les derniers taux de change des devises dans la liste **Devises**. Pour plus d’informations, reportez vous à [Configurer un service de taux de change des devises](finance-how-update-currencies.md#to-set-up-a-currency-exchange-rate-service).  
