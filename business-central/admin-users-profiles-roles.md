...
ms.search.form: 9171
---
# <a name="manage-user-profiles" />Gérer les profils d’utilisateur
...
## <a name="page-customization" />Personnalisation de page
...
## <a name="to-create-a-profile" />Pour créer un profil
...
## <a name="to-copy-a-profile" />Pour copier un profil
...
## <a name="to-edit-a-profile" />Pour modifier un profil
...
## <a name="to-assign-a-profile-to-a-user" />Pour affecter un profil à un utilisateur
...
## <a name="to-define-user-settings-for-a-profile" />Pour définir les paramètres utilisateur d’un profil
...
## <a name="to-activate-a-profile" />Pour activer un profil
...
## <a name="to-export-profiles" />Pour exporter des profils
...
## <a name="to-import-profiles" />Pour importer des profils
...
## <a name="to-delete-a-profile" />Pour supprimer un profil
...
## <a name="to-delete-all-personalizations-made-by-a-user" />Pour supprimer toutes les personnalisations effectuées par un utilisateur
...
## <a name="to-delete-personalizations-for-specific-pages" />Pour supprimer des personnalisations pour des pages spécifiques
...
## <a name="managing-user-sessions" />Gestion des sessions utilisateur
...
## <a name="see-related-microsoft-trainingtrainingmodulesusers-security-dynamics--business-central" />Voir la [formation Microsoft](/training/modules/users-security-dynamics-365-business-central/) associée
