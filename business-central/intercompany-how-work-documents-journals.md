...
---
# <a name="work-with-intercompany-documents-and-journals" />Utiliser les documents et les feuilles intersociétés
...
## <a name="fill-in-and-send-an-intercompany-sales-order" />Renseigner et envoyer une commande vente intersociétés
...
## <a name="fill-in-and-post-an-intercompany-journal" />Renseigner et valider une feuille intersociétés
