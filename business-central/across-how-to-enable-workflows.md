...
ms.locfileid: "9130063"
---
# <a name="enable-workflows"></a>Activer des flux de travail

Lorsque vous avez créé un flux de travail et que vous êtes sûr qu’il est prêt à démarrer, vous devez l’activer.  
...
## <a name="to-enable-a-workflow"></a>Activer un flux de travail
