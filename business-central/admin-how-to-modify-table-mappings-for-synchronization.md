...
Une table d'intégration est une table dans la base de données [!INCLUDE[d365fin](includes/d365fin_md.md)] qui représente une entité, par exemple un compte, dans [!INCLUDE[d365fin](includes/cds_long_md.md)]. Les tables d'intégration incluent des champs qui correspondent aux champs de la table de l'entité [!INCLUDE[d365fin](includes/cds_long_md.md)]. Par exemple, la table d'intégration Compte se connecte à l'entité Comptes dans [!INCLUDE[d365fin](includes/cds_long_md.md)]. Il doit y avoir un mappage de table d'intégration pour chaque entité dans [!INCLUDE[d365fin](includes/cds_long_md.md)] à synchroniser avec les données dans [!INCLUDE[d365fin](includes/d365fin_md.md)].
