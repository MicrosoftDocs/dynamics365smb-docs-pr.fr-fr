...
---
# <a name="share-and-export-reports-with-the-report-inbox" />Partager et exporter des états avec la boîte de réception état
...
## <a name="download-generated-reports" />Télécharger les états générés
...
## <a name="open-generated-reports-in-onedrive" />Ouvrir les états générés dans OneDrive
...
## <a name="share-scheduled-reports" />Partager les états planifiés
