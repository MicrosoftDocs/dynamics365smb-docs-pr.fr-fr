...
Pour plus d’informations sur les différents types de licences et le fonctionnement des licences dans [!INCLUDE[prod_short](includes/prod_short.md)], consultez le Guide des licences Dynamics 365, à partir duquel vous pouvez télécharger [https://go.microsoft.com/fwlink/?LinkId=866544](https://go.microsoft.com/fwlink/?LinkId=866544).
...
3. Choisissez **Mettre à jour les utilisateurs depuis Office 365**.
...
> [!NOTE]
> Les actions décrites dans le tableau suivant sont exactes, cependant, la seule dont vous ayez besoin est **Mettre à jour les utilisateurs depuis Office 365**, qui a été ajoutée pour simplifier le processus. Les autres actions seront supprimées dans une future version de [!INCLUDE[prod_short](includes/prod_short.md)].
...
|Mettez à jour l’utilisateur en fonction des informations dans Microsoft 365 : État, Nom complet, E-mail du contact, adresse e-mail d’authentification.<!--<br /><br />Codeunit "Azure AD   Graph User".UpdateUserFromAzureGraph-->|**X**|**X**|**X**|**X**||**X**|
