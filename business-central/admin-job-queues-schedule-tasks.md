...
## <a name="scheduling-synchronization-between-d365fin-and-crm_md"></a>Planification de la synchronisation entre [!INCLUDE[d365fin](includes/d365fin_md.md)] et [!INCLUDE[crm_md](includes/crm_md.md)]
