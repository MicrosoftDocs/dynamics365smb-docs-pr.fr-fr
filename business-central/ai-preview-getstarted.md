...
# <a name="get-started-with-a-business-central-preview-version-for-copilot" />Démarrer par une version en version préliminaire de Business Central pour Copilot
...
## <a name="your-organization-already-uses-business-central" />Votre organisation utilise déjà Business Central
...
## <a name="your-organization-doesnt-use-business-central" />Votre organisation n’utilise pas Business Central
