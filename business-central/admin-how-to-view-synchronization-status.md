...
|**Synchroniser**|L’application tentera de résoudre un conflit lorsqu’un enregistrement a été modifié dans les deux applications professionnelles. Vous pouvez choisir la version de l’enregistrement à utiliser.|
