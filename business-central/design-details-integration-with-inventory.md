...
ms.author: edupont
---
# <a name="design-details-integration-with-inventory" />Détails de conception : intégration avec le stock
...
## <a name="physical-inventory" />Inventaire
...
## <a name="warehouse-adjustments-to-the-item-ledger" />Ajustements d’entrepôt dans l’écriture article
