...
### <a name="number-series-and-lump-sum-deposits"></a>Souches de numéros et dépôts forfaitaires
...
### <a name="general-journal-templates-for-bank-deposits"></a>Modèles feuille comptabilité pour les dépôts bancaires
...
## <a name="finding-posted-bank-deposits"></a>Recherche de dépôts bancaires validés
...
## <a name="reversing-a-posted-bank-deposit"></a>Annulation d’un dépôt bancaire validé
