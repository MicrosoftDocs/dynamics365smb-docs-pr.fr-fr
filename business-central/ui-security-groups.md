...
# <a name="control-access-to-business-central-using-security-groups" />Contrôler l’accès à Business Central à l’aide de groupes de sécurité
...
## <a name="business-central-online-and-on-premises" />Business Central Online et support local
...
## <a name="add-a-security-group-in-business-central" />Ajouter un groupe de sécurité dans Business Central
...
### <a name="assign-permissions-to-a-security-group" />Attribuer des autorisations à un groupe de sécurité
...
## <a name="review-the-permissions-in-a-security-group" />Vérifier les autorisations dans un groupe de sécurité
...
## <a name="security-groups-and-user-groups" />Groupes de sécurité et groupes d’utilisateurs
...
### <a name="optional-convert-user-groups-to-permission-sets" />En option : Convertir des groupes d’utilisateurs en ensembles d’autorisations
