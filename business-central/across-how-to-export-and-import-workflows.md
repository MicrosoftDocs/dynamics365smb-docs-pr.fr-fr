...
---
# <a name="export-and-import-approval-workflows"></a><a name="export-and-import-approval-workflows"></a>Exporter et importer des flux de travail approbation
...
## <a name="export-a-workflow"></a><a name="export-a-workflow"></a>Exporter un flux de travail
...
## <a name="import-a-workflow"></a><a name="import-a-workflow"></a>Importer un flux de travail
