...
# <a name="ai-powered-item-marketing-text-preview-with-copilot-faq" />FAQ sur le texte marketing article optimisé par l’IA (version préliminaire) avec Copilot
...
### <a name="what-is-copilot" />Qu’est-ce que Copilot ?
...
### <a name="why-isnt-copilot-available-for-marketing-text-on-my-items-in-business-central" />Pourquoi Copilot n’est-il pas disponible pour le texte marketing sur mes articles dans Business Central ?
...
### <a name="is-copilot-available-for-preview-in-business-central-on-premises" />Est-ce que Copilot est disponible en version préliminaire dans Business Central sur site ?

Non, il n’est actuellement pas pris en charge dans Business Central sur site.

### <a name="how-does-copilot-work-where-does-the-suggested-text-come-from" />Comment fonctionne Copilot, d’où vient le texte suggéré ?
...
### <a name="whats-the-quality-of-the-text-suggested-by-copilot" />Quelle est la qualité du texte proposé par Copilot ?
...
### <a name="how-can-i-improve-the-suggestions-i-get-from-copilot" />Comment puis-je améliorer les suggestions que je reçois de Copilot ?
...
### <a name="what-if-im-not-satisfied-with-the-generated-text" />Que faire si je ne suis pas satisfait du texte généré ?
...
### <a name="can-admins-disable-copilot-if-so-how" />Les administrateurs peuvent-ils désactiver Copilot ? Si oui, comment ?
...
### <a name="does-copilot-work-with-languages-other-than-english" />Copilot fonctionne-t-il avec des langues autres que l’anglais ?
...
### <a name="whats-done-about-abusive-and-harmful-text-suggestions" />Que fait-on des suggestions de texte abusives et préjudiciables ?
...
### <a name="can-i-opt-out-of-the-logging-and-human-review-process" />Puis-je désactiver le processus de journalisation et d’examen humain ?
...
### <a name="what-data-does-the-capability-collect-how-is-the-data-used" />Quelles données la fonctionnalité recueille-t-elle ? Comment les données sont-elles utilisées ?
