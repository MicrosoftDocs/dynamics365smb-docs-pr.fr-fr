...
---
# <a name="design-details-cost-adjustment" /><a name="design-details-cost-adjustment"></a>Détails de conception : ajustement des coûts
...
## <a name="detecting-the-adjustment" /><a name="detecting-the-adjustment"></a>Détection de l’ajustement
...
### <a name="item-application-entry" /><a name="item-application-entry"></a>Écriture lettrage article
...
### <a name="average-cost-adjustment-entry-point" /><a name="average-cost-adjustment-entry-point"></a>Point d’entrée d’ajustement de coût moyen
...
### <a name="order-level" /><a name="order-level"></a>Niveau de commande
...
## <a name="manual-versus-automatic-cost-adjustment" /><a name="manual-versus-automatic-cost-adjustment"></a>Comparaison entre ajustement des coûts automatique et manuel
...
## <a name="adjust-cost---item-entries-batch-job" /><a name="adjust-cost---item-entries-batch-job"></a>Traitement par lots Ajuster coûts - Écr. article
...
### <a name="example" /><a name="example"></a>Exemple :
...
## <a name="automatic-cost-adjustment" /><a name="automatic-cost-adjustment"></a>Ajustement automatique des coûts
...
### <a name="example-1" /><a name="example"></a>Exemple :
