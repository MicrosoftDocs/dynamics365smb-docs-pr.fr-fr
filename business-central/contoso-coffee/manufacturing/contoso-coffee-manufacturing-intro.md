...
# <a name="introduction-to-contoso-coffee-manufacturing"></a><a name="introduction-to-contoso-coffee-manufacturing"></a>Introduction à la fabrication Contoso Coffee
...
## <a name="set-up-contoso-coffee-manufacturing-data"></a><a name="set-up-contoso-coffee-manufacturing-data"></a>Configurer les données de fabrication Contoso Coffee
...
## <a name="scenarios"></a><a name="scenarios"></a>Cas de figure
