...
#### [Rangement des articles avec les rangement stock](warehouse-how-to-put-items-away-with-inventory-put-aways.md)
...
##### [Affectation des codes de relance livraison à des fournisseurs](LocalFunctionality/Germany/how-to-assign-delivery-reminder-codes-to-vendors.md)
...
###### [Retours achats auprès d’un fournisseur non enregistré (taxe déductible)](LocalFunctionality/India/GST-Purchase-Return-to-Unregistered-Vendor-RCM.md) 
...
##### [Paiement de la TDS à l’autorité](LocalFunctionality/India/TDS-TDS-Payment-to-Authority.md)
...
##### [Création d’une responsabilité en matière de GST](LocalFunctionality/India/Subcontracting-Create-GST-Liability.md)
...
#### Finances de base
##### [Clôture d’un exercice fiscal](LocalFunctionality/Italy/how-to-close-a-fiscal-year.md)
...
##### [Impression des états de rapprochement de compte bancaire](LocalFunctionality/NewZealand/how-to-print-bank-account-reconciliation-reports.md)
#### Finances de base
##### [Calcul des montants de la distribution](LocalFunctionality/NewZealand/calculating-distribution-amounts.md)
##### [Impression des états du bilan](LocalFunctionality/NewZealand/how-to-print-balance-sheet-reports.md)
##### [Impression des comptes de gestion](LocalFunctionality/NewZealand/how-to-print-income-statements.md)
#### Général
##### [Adresses](LocalFunctionality/NewZealand/addresses.md)
##### [Détermination du prix de vente par coût majoré du pourcentage](LocalFunctionality/NewZealand/how-to-determine-sales-price-by-cost-plus-percentage.md)
##### [Saisie des numéros d’entreprise néo-zélandais](LocalFunctionality/NewZealand/how-to-enter-new-zealand-business-numbers.md)  
##### [Numéros du service sur les revenus intérieurs néo-zélandais et notes d’ajustement](LocalFunctionality/NewZealand/new-zealand-business-numbers-and-adjustment-notes.md)

### Norvège
#### [Fonctionnalité locale dans la version norvégienne](LocalFunctionality/Norway/norway-local-functionality.md)
#### TVA
##### [Fichier d’audit standard norvégien – Gestion des taxes (SAF-T)](LocalFunctionality/Norway/ui-extensions-setup-and-generate-saf-t-files-no.md)
...
##### [Procédure d’utilisation d’un code TVA dans les feuilles](LocalFunctionality/Norway/how-to-use-one-vat-code-in-journals.md)
##### [TVA proportionnelle](LocalFunctionality/Norway/proportional-vat.md)
##### [Calcul de la TVA proportionnelle](LocalFunctionality/Norway/how-to-calculate-proportional-vat.md)
##### [Impression d’état sur le rapprochement TVA](LocalFunctionality/Norway/how-to-print-a-vat-reconciliation-report.md)
#### Banque et paiements
...
##### [Configuration des clients pour l’EHF](LocalFunctionality/Norway/how-to-set-up-customers-for-ehf.md)  
##### [Configuration de l’EHF](LocalFunctionality/Norway/how-to-set-up-ehf.md)
##### [Création des documents électroniques pour l’EHF](LocalFunctionality/Norway/how-to-create-electronic-documents-for-ehf.md)
##### [Création des paiements de remise manuels](LocalFunctionality/Norway/how-to-create-manual-remittance-payments.md)  
##### [Configuration des accords de remise](LocalFunctionality/Norway/how-to-set-up-remittance-agreements.md)  
##### [Configuration des fournisseurs pour remise](LocalFunctionality/Norway/how-to-set-up-vendors-for-remittance.md)
##### [Codes de référence destinataire](LocalFunctionality/Norway/recipient-reference-codes.md)
##### [Configuration des informations de ligne de paiement](LocalFunctionality/Norway/how-to-set-up-payment-line-information.md)  
##### [Création des comptes de remise](LocalFunctionality/Norway/how-to-create-remittance-accounts.md)  
##### [Paiements de remise test](LocalFunctionality/Norway/how-to-test-remittance-payments.md)
##### [Création des propositions de remise](LocalFunctionality/Norway/how-to-create-remittance-suggestions.md)
##### [Types de fichiers de retour de paiement](LocalFunctionality/Norway/types-of-payment-returns-files.md)
##### [Importation des données de retour de paiement](LocalFunctionality/Norway/how-to-import-payment-return-data.md)
##### [Erreurs de remise](LocalFunctionality/Norway/remittance-errors.md)
##### [Affichage des codes d’erreur de remise](LocalFunctionality/Norway/how-to-view-remittance-error-codes.md)
##### [Annulation des paiements](LocalFunctionality/Norway/how-to-cancel-payments.md)  
##### [Suppression des ordres paiement de remise](LocalFunctionality/Norway/how-to-delete-remittance-payment-orders.md)  
##### [Exportation des paiements de remise](LocalFunctionality/Norway/how-to-export-remittance-payments.md)
##### [Virement norvégien et police OCR-B](LocalFunctionality/Norway/norwegian-giro-and-ocr-b-font.md)
##### [Configuration des paiements OCR](LocalFunctionality/Norway/how-to-set-up-ocr-payments.md)
##### [Importation et validation des paiements OCR](LocalFunctionality/Norway/how-to-import-and-post-ocr-payments.md)
##### [Impression d’un état test sur le journal OCR](LocalFunctionality/Norway/how-to-print-the-ocr-journal-test-report.md)  
#### Finances de base
##### [Lettrage des écritures comptables dans les périodes clôturées](LocalFunctionality/Norway/how-to-apply-general-ledger-entries-in-closed-periods.md)  
#### Général
##### [Commandes périodiques](LocalFunctionality/Norway/recurring-orders.md)  
##### [Création de commandes périodiques](LocalFunctionality/Norway/how-to-create-recurring-orders.md)
##### [Configuration des groupes périodiques](LocalFunctionality/Norway/how-to-set-up-recurring-groups.md)  
##### [Configuration des commandes périodiques](LocalFunctionality/Norway/how-to-set-up-recurring-orders.md)
##### [Définitions de données de paie](LocalFunctionality/Norway/ui-extensions-payroll-data-definitions-no.md)
##### [Importation des transactions de paie](LocalFunctionality/Norway/how-to-import-payroll-transactions.md)
##### [Configuration des numéros KID sur les documents vente](LocalFunctionality/Norway/how-to-set-up-kid-numbers-on-sales-documents.md)
##### [Configuration de l’impression de documents](LocalFunctionality/Norway/how-to-set-up-document-printing.md)

### Russie
#### [Fonctionnalité locale dans la version russe](LocalFunctionality/Russia/russia-local-functionality.md)
#### Finances de base
##### [Vue d’ensemble des états financiers](LocalFunctionality/Russia/account-schedules-overview.md)
##### [Importation et exportation des états financiers](LocalFunctionality/Russia/How-to-Import-and-Export-Account-Schedules.md)
##### [Définition d’une extension d’état financier](LocalFunctionality/Russia/How-to-Define-an-Account-Schedule-Extension.md)
##### [Définition d’une constante d’état financier](LocalFunctionality/Russia/How-to-Define-an-Account-Schedule-Constant.md)
##### [Utilisation des états financiers](LocalFunctionality/Russia/How-to-Work-with-Account-Schedules.md)
##### [Correspondance comptable](LocalFunctionality/Russia/general-ledger-correspondence.md)
##### [Devise](LocalFunctionality/Russia/Currency-information-Import-currency-rates.md)
##### [Configuration des employés responsables et des déclarations préalables](LocalFunctionality/Russia/How-to-Set-Up-Responsible-Employees-and-Advance-Statements.md)
#### Fournisseurs et clients
##### [Comptabilité client et fournisseur dans la version russe](LocalFunctionality/Russia/Payables-and-Receivables.md)
##### [Saisie des informations de déclaration douanière](LocalFunctionality/Russia/how-to-enter-custom-declarations-information.md)
##### [Configuration et création des procurations](LocalFunctionality/Russia/how-to-set-up-and-create-letters-of-attorney.md)
##### [États sur les fournisseurs russes](LocalFunctionality/Russia/russian-payables-reports.md)
##### [États sur les clients russes](LocalFunctionality/Russia/russian-receivables-reports.md)
##### [Configuration des acomptes client](LocalFunctionality/Russia/how-to-set-up-customer-prepayments.md)
##### [Configuration des acomptes fournisseur](LocalFunctionality/Russia/how-to-set-up-vendor-prepayments.md)
##### [Validation des acomptes fournisseur et client](LocalFunctionality/Russia/prepayments-vendor-and-customers.md)
##### [Différences entre acomptes](LocalFunctionality/Russia/prepayment-differences-invoices-prepayment-differences.md)
##### [Configuration des accords client et fournisseur](LocalFunctionality/Russia/how-to-set-up-customer-and-vendor-agreements.md)
#### Immobilisations
##### [Immobilisations dans la version russe](LocalFunctionality/Russia/fixed-assets.md)
##### [Calcul de la taxe évaluée](LocalFunctionality/Russia/How-to-Calculate-Assessed-Tax.md)
##### [Prime d’amortissement](LocalFunctionality/Russia/Depreciation-Bonus.md)
##### [Frais d’immobilisations](LocalFunctionality/Russia/Fixed-Asset-Charges.md)
...
##### [Création des journaux de dépenses futures](LocalFunctionality/Russia/How-to-Create-Future-Expense-Journals.md)
##### [Création de frais d’immobilisations](LocalFunctionality/Russia/How-to-Create-a-Fixed-Asset-Charge.md)
##### [Création d’un avoir pour des frais d’immobilisations](LocalFunctionality/Russia/How-to-Create-a-Credit-Memo-for-a-Fixed-Asset-Charge.md)
##### [Vente des immobilisations](LocalFunctionality/Russia/Sale-of-fixed-assets.md)
##### [Lancement, suivi et annulation des immobilisations](LocalFunctionality/Russia/How-to-Release-Track-Write-Off-Fixed-Assets.md)
##### [Affichage des entrées publiées sur des frais d’immobilisations](LocalFunctionality/Russia/How-to-View-Posted-Entries-on-a-Fixed-Asset-Charge.md)
##### [Configuration d’un compte d’immobilisations incorporelles](LocalFunctionality/Russia/How-to-Set-Up-an-Intangible-Assets-Account.md)
##### [Comptabilisation du coût d’élimination d’une immobilisation](LocalFunctionality/Russia/How-to-Account-for-the-Cost-to-Dispose-a-Fixed-Asset.md)
##### [Immobilisations non amortissables](LocalFunctionality/Russia/Undepreciable-Fixed-Assets.md)
#### TVA
##### [TVA dans la version russe](LocalFunctionality/Russia/VAT.md)
##### [Configuration des écritures TVA](LocalFunctionality/Russia/How-to-Set-Up-VAT-Ledgers.md)  
##### [Préparation et validation des écritures TVA](LocalFunctionality/Russia/How-to-Prepare-VAT-Entries-for-Posting.md)  
##### [Déclaration de TVA](LocalFunctionality/Russia/Settlement-VAT.md)  
##### [Chargement des registres des achats et des ventes et de la déclaration de TVA au format XML](LocalFunctionality/Russia/upload-books-purchases-sales-xml-vat-declaration.md)  
##### [TVA par acompte client](LocalFunctionality/Russia/VAT-by-Customer-prepayments.md)  
...
#### Comptes de taxe
##### [Comptes de taxe dans la version russe](LocalFunctionality/Russia/Tax-Accounting.md)
##### [Configuration des comptes de taxe](LocalFunctionality/Russia/How-to-Set-Up-Tax-Accounting.md)  
##### [Registres de taxes](LocalFunctionality/Russia/Tax-Registers.md)  
##### [Création des registres de taxes](LocalFunctionality/Russia/How-to-Create-Tax-Registers.md)  
##### [Configuration des sections du registre de taxes](LocalFunctionality/Russia/How-to-Set-Up-Tax-Register-Sections.md)
##### [Différences de taxes](LocalFunctionality/Russia/Tax-Differences.md)  
...
##### [Chargement de KLADR](LocalFunctionality/Russia/Upload-KLADR.md)  
##### [États statutaires](LocalFunctionality/Russia/Statutory-Reports.md)
#### Banque
##### [Gestion bancaire](LocalFunctionality/Russia/bank-management.md)
#### Stock
##### [Stock dans la version russe](LocalFunctionality/Russia/Inventory.md)
##### [Configuration du stock](LocalFunctionality/Russia/Inventory-Setup.md)
##### [Documents sur les articles](LocalFunctionality/Russia/Item-Documents.md)
##### [Lois obligatoires sur les articles](LocalFunctionality/Russia/Item-Obligatory-Acts.md)
##### [Loi sur l’inventaire des clients et des fournisseurs INV-17](LocalFunctionality/Russia/Inventory-Act-of-Receivables-And-Payables-INV-17.md)
##### [Rotation comptable des articles](LocalFunctionality/Russia/Item-General-Ledger-Turnover.md)
##### [Création de l’état sur les marchandises TORG-29](LocalFunctionality/Russia/How-to-Create-the-TORG-29-Goods-Report.md)
##### [Connaissement](LocalFunctionality/Russia/bill-of-lading.md)
#### Ressources humaines
##### [Ressources humaines dans la version russe](LocalFunctionality/Russia/Human-Resources.md)
...
##### [Enregistrement d’indisponibilité](LocalFunctionality/Russia/Absence-registration.md)
##### [Renvoi](LocalFunctionality/Russia/Dismissal.md)
##### [Établissement et modification de l’ordre de la liste du personnel](LocalFunctionality/Russia/Forming-and-changing-Staff-List-Order-Staff-Arrangement.md)
##### [Planifiez vos vacances](LocalFunctionality/Russia/Vacation-planning.md)

### Espagne
#### [Fonctionnalité locale dans la version espagnole](LocalFunctionality/Spain/spain-local-functionality.md)
#### TVA
##### [États TVA](LocalFunctionality/Spain/vat-reports.md)
##### [État 340](LocalFunctionality/Spain/report-340.md)  
##### [Création de l’état 340](LocalFunctionality/Spain/how-to-create-report-340.md)  
##### [État 347](LocalFunctionality/Spain/report-347.md)  
##### [Création de l’état 347](LocalFunctionality/Spain/how-to-create-report-347.md)  
##### [État 349](LocalFunctionality/Spain/report-349.md)  
##### [Création de l’état 349](LocalFunctionality/Spain/how-to-create-report-349.md)  
##### [Configuration des états 340 pour les petites entreprises](LocalFunctionality/Spain/how-to-set-up-340-reports-for-small-businesses.md)
##### [Configuration de SII pour les états TVA](LocalFunctionality/Spain/sii-setup.md)
##### [Création des modèles pour des déclarations télématiques de TVA au format de fichier texte](LocalFunctionality/Spain/how-to-create-templates-for-telematic-vat-statements-in-text-file-format.md)
##### [Création des modèles pour des déclarations télématiques de TVA au format de fichier XML](LocalFunctionality/Spain/how-to-create-templates-for-telematic-vat-statements-in-xml-file-format.md)
##### [Exportation des déclarations de TVA au format XML](LocalFunctionality/Spain/how-to-export-vat-statements-in-xml-format.md)  
##### [Exportation des déclarations de TVA au format texte](LocalFunctionality/Spain/how-to-export-vat-statements-in-text-format.md)
...
##### [Configuration des comptes bancaires pour les paiements électroniques](LocalFunctionality/Spain/how-to-set-up-bank-accounts-for-electronic-payments.md)
##### [Paiement des fournisseurs à l’aide de paiements électroniques](LocalFunctionality/Spain/how-to-pay-vendors-by-using-electronic-payments.md)
##### [Exportation des paiements électroniques](LocalFunctionality/Spain/how-to-export-electronic-payments.md)
##### [Annulation des paiements électroniques](LocalFunctionality/Spain/how-to-void-electronic-payments.md)
##### [Configuration des codes CCC bancaires](LocalFunctionality/Spain/how-to-set-up-bank-ccc-codes.md)
##### [Saisie des codes CCC](LocalFunctionality/Spain/how-to-enter-ccc-codes.md)
##### [Configuration des jours de paiement et des périodes de non-paiement](LocalFunctionality/Spain/how-to-set-up-payment-days-and-non-payment-periods.md)
##### [Règlements en espèces](LocalFunctionality/Spain/payments-in-cash.md)
#### Factures électroniques
##### [Module Cartera](LocalFunctionality/Spain/cartera-module.md)
##### [Module Cartera clients](LocalFunctionality/Spain/receivables-cartera-module.md)
##### [Module Cartera de paiements](LocalFunctionality/Spain/payments-cartera-module.md)
##### [SII – Types Facture et Avoir dans des documents Vente et Achat](LocalFunctionality/Spain/SII-invoice-types-sales-purchase-documents.md)
#### Finances de base
##### [Configuration et clôture des soldes de comptes de gestion](LocalFunctionality/Spain/how-to-set-up-and-close-income-statement-balances.md)
##### [Indentation et validation des plans comptables](LocalFunctionality/Spain/how-to-indent-and-validate-chart-of-accounts.md)
##### [Possibilité d’ignorer les remises dans les comptes généraux](LocalFunctionality/Spain/how-to-ignore-discounts-in-general-ledger-accounts.md)
##### [Exportation des états financiers au format ASC](LocalFunctionality/Spain/how-to-export-account-schedules-to-asc-format.md)
##### [Impression des états sur lois d’amortissement de compte](LocalFunctionality/Spain/how-to-print-account-book-reports.md)
##### [Impression des registres de facturation ventes et achats](LocalFunctionality/Spain/how-to-print-sales-and-purchase-invoice-books.md)  
##### [Numéros de transactions](LocalFunctionality/Spain/transaction-numbers.md)
##### [Impression et validation de toutes les transactions d’une période définie](LocalFunctionality/Spain/how-to-post-and-print-all-transactions-for-a-period.md)
#### Général
...
##### [Configuration des codes opération](LocalFunctionality/Spain/how-to-set-up-operation-codes.md)
##### [Saisie des codes NACE](LocalFunctionality/Spain/how-to-enter-nace-codes.md)
##### [Définition des limites des dates d’échéance](LocalFunctionality/Spain/how-to-set-limits-for-due-dates.md)

### Suède
#### [Fonctionnalité locale dans la version suédoise](LocalFunctionality/Sweden/sweden-local-functionality.md)
#### TVA
##### [Configuration des transactions d’achat de tiers dans l’UE](LocalFunctionality/Sweden/how-to-set-up-eu-third-party-purchase-transactions.md)
#### Finances de base
##### [Codes compte automatiques](LocalFunctionality/Sweden/automatic-account-codes.md)  
##### [Configuration des groupes comptabilisation automatiques](LocalFunctionality/Sweden/how-to-set-up-automatic-account-posting-groups.md)
##### [Importation et exportation des données au format standard d’importation-exportation](LocalFunctionality/Sweden/how-to-import-and-export-data-in-standard-import-export-format.md)  
##### [Impression du bilan et de la déclaration de revenus](LocalFunctionality/Sweden/how-to-print-balance-sheet-and-income-statement-reports.md)  

### Suisse
#### [Fonctionnalité locale dans la version suisse](LocalFunctionality/Switzerland/switzerland-local-functionality.md)
#### TVA
##### [Création et impression d’une déclaration de TVA suisse](LocalFunctionality/Switzerland/how-to-create-and-print-a-swiss-vat-statement.md)
##### [Impression des déclarations de TVA suisses (anciennes versions)](LocalFunctionality/Switzerland/how-to-print-swiss-vat-statements-older-version-.md)
...
##### [Paiements électroniques suisses](LocalFunctionality/Switzerland/swiss-electronic-payments.md)
##### [Paiements électroniques suisses à l’aide de l’ESR](LocalFunctionality/Switzerland/swiss-electronic-payments-using-esr.md)
##### [Paiements électroniques suisses à l’aide de l’LSV](LocalFunctionality/Switzerland/swiss-electronic-payments-using-lsv-.md)
##### [Traitement d’un recouvrement LSV](LocalFunctionality/Switzerland/how-to-process-an-lsv-collection.md)
##### [Validation des paiements LSV](LocalFunctionality/Switzerland/how-to-post-lsv-payments.md)
##### [Clôture d’un recouvrement LSV](LocalFunctionality/Switzerland/how-to-close-an-lsv-collection.md)
##### [Exportation des paiements en mode LSV](LocalFunctionality/Switzerland/how-to-export-payments-using-lsv.md)
##### [Importation des paiements ESR](LocalFunctionality/Switzerland/how-to-import-esr-payments.md)
##### [Impression des factures ESR](LocalFunctionality/Switzerland/how-to-print-esr-invoices.md)
##### [Importation des numéros de compensations bancaires suisses](LocalFunctionality/Switzerland/how-to-import-swiss-bank-clearing-numbers.md)
##### [Impression des états contenant les listes de paiements fournisseur](LocalFunctionality/Switzerland/how-to-print-vendor-payments-list-reports.md)
#### Finances de base
##### [Comptes généraux suisses](LocalFunctionality/Switzerland/swiss-general-ledger-accounts.md)
##### [Solde](LocalFunctionality/Switzerland/balance.md)
##### [Ajustement des taux de change](LocalFunctionality/Switzerland/how-to-adjust-exchange-rates.md)
##### [Affichage des soldes temporaires dans les feuilles comptabilité](LocalFunctionality/Switzerland/how-to-view-temporary-balances-in-general-ledger-journals.md)
##### [Impression des informations liées aux paramètres comptabilité](LocalFunctionality/Switzerland/how-to-print-general-ledger-setup-information.md)
#### Achats
##### [Relances livraison](LocalFunctionality/Switzerland/delivery-reminders.md)
##### [Configuration des relances livraison](LocalFunctionality/Switzerland/how-to-set-up-delivery-reminders.md)
##### [Configuration des conditions, niveaux et textes de relance livraison](LocalFunctionality/Switzerland/how-to-set-up-delivery-reminder-terms-levels-and-text.md)
##### [Affectation des codes livraison à des fournisseurs](LocalFunctionality/Switzerland/how-to-assign-delivery-reminder-codes-to-vendors.md)
##### [Création manuelle des relances livraison](LocalFunctionality/Switzerland/how-to-create-delivery-reminders-manually.md)
##### [Émission des relances livraison](LocalFunctionality/Switzerland/how-to-issue-delivery-reminders.md)
##### [Génération des relances livraison](LocalFunctionality/Switzerland/how-to-generate-delivery-reminders.md)
##### [Impression des états de test pour les relances livraison](LocalFunctionality/Switzerland/how-to-print-test-reports-for-delivery-reminders.md)
#### Stock
##### [Gestion des stocks suisse](LocalFunctionality/Switzerland/swiss-inventory-management.md)
##### [Impression de la liste des prélèvements stock d’une commande vente](LocalFunctionality/Switzerland/how-to-print-an-inventory-picking-list-from-a-sales-order.md)
#### Général
##### [Importation des codes postaux suisses](LocalFunctionality/Switzerland/how-to-import-swiss-post-codes.md)
##### [Documents achat et commandes vente suisses](LocalFunctionality/Switzerland/swiss-purchase-documents-and-sales-documents.md)

### Royaume-Uni
#### [Fonctionnalité locale dans la version britannique](LocalFunctionality/UnitedKingdom/united-kingdom-local-functionality.md)
#### TVA
##### [Numérisation des taxes – Soumission de retours TVA](LocalFunctionality/UnitedKingdom/making-tax-digital-submit-vat-return.md)
##### [Modification de la configuration de la TVA dans les feuilles](LocalFunctionality/UnitedKingdom/how-to-change-vat-setup-in-journals.md)
##### [Impression des états d’audit de TVA](LocalFunctionality/UnitedKingdom/how-to-print-vat-audit-reports.md)
##### [Impression des déclarations de TVA](LocalFunctionality/UnitedKingdom/how-to-print-vat-reports.md)
##### [Configuration de la TVA au preneur](LocalFunctionality/UnitedKingdom/how-to-set-up-reverse-charges-on-vat.md)
#### Banque et paiements
##### [Impression des chèques pour APACS](LocalFunctionality/UnitedKingdom/how-to-print-checks-for-apacs.md)
##### [Impression de l’avis de remise](LocalFunctionality/UnitedKingdom/how-to-print-remittance-advice.md)
#### Immobilisations
##### [Définition des périodes comptables pour l’amortissement linéaire des immobilisations](LocalFunctionality/UnitedKingdom/how-to-define-accounting-periods-for-straight-line-depreciation-of-fixed-assets.md)
#### Général
##### [Configuration d’un avertissement de date comptabilisation](LocalFunctionality/UnitedKingdom/how-to-set-up-a-posting-date-warning.md)
##### [Saisie des informations statutaires](LocalFunctionality/UnitedKingdom/how-to-enter-statutory-information.md)
##### [Envoi des données de prévention contre les fraudes](LocalFunctionality/UnitedKingdom/fraud-prevention-data.md)
##### [Extension des codes postaux du R.-U. GetAddress.io](LocalFunctionality/UnitedKingdom/ui-extensions-getaddressio.md)
##### [Configuration de l’extension des codes postaux du R.-U. GetAddress.io](LocalFunctionality/UnitedKingdom/uk-setup-postal-code-service.md)
...
##### [Configuration et utilisation du formulaire IRS 1099](LocalFunctionality/UnitedStates/set-up-use-irs1099-form.md)
##### [Modifications et détails du format 1099 réglementaire](LocalFunctionality/UnitedStates/tax-1099-changes.md)  
##### [Configuration et utilisation du formulaire IRS 1096](LocalFunctionality/UnitedStates/set-up-use-irs1096-form.md)
##### [Configuration de la taxe d’utilisation et de la taxe achats](LocalFunctionality/UnitedStates/how-to-set-up-use-tax-and-purchase-tax.md)  
##### [Configuration des taxes sur les ventes non réalisées et des remises de paiement des ventes](LocalFunctionality/UnitedStates/how-to-set-up-unrealized-sales-tax-and-sales-payment-discounts.md)  
#### Banque et paiements
##### [Création des dépôts](LocalFunctionality/UnitedStates/how-to-create-deposits.md)  
##### [Rapprochement des comptes bancaires](LocalFunctionality/UnitedStates/how-to-reconcile-bank-accounts.md)
##### [Désignation des paiements électroniques](finance-make-payments-with-bank-data-conversion-service-or-sepa-credit-transfer.md#exporting-payments-to-a-bank-file)
#### Général
##### [Impression des états sur la résolution de problèmes](LocalFunctionality/UnitedStates/how-to-print-troubleshooting-reports.md)
### [Envoi des alertes de réglementation](submit-regulatory-alerts.md)
...
#### [Utilisation des écarts de règlement et des écarts d’escompte](finance-payment-tolerance-and-payment-discount-tolerance.md)
#### [Utilisation des périodes comptables et des exercices comptables](finance-accounting-periods-and-fiscal-years.md)
#### [Configuration des conditions et niveaux de relance](finance-setup-reminders.md)
...
#### [Configuration des méthodes de calcul et de validation de la TVA](finance-setup-vat.md)
#### [Configuration de la TVA non réalisée pour la comptabilité basée sur la trésorerie](finance-setup-unrealized-vat.md)
#### [Validation des n° identif. intracomm.](finance-how-validate-vat-registration-number.md)
#### [Configuration des codes sources et des codes motifs pour les pistes d’audit](finance-setup-trail-codes.md)
#### [Activation du lettrage d’écritures comptables en devises différentes](finance-how-enable-application-ledger-entries-different-currencies.md)
#### [Configuration d’une devise report supplémentaire](finance-how-setup-additional-currencies.md)
#### [Mise à jour des taux de change devise](finance-how-update-currencies.md)
#### [Configuration de plusieurs taux d’intérêt](finance-how-to-set-up-multiple-interest-rates.md)
#### [Configuration de l’arrondi facture](finance-set-up-invoice-rounding.md)
#### [Configuration du plan comptable](finance-setup-chart-accounts.md)
#### [Configuration de l’analyse de la trésorerie](finance-setup-cash-flow-analyses.md)
#### [Configuration des clients effectuant un achat en espèces](finance-how-to-set-up-cash-customers.md)
#### [Configuration de la déclaration d’échanges de biens](finance-how-setup-report-intrastat.md)
#### [Utilisation des clés de ventilation dans les feuilles comptabilité](ui-how-use-allocation-keys-general-journals.md)
...
#### [Configuration des groupes prix client](sales-how-to-set-up-customer-price-groups.md)
#### [Configuration des groupes remises client](sales-how-to-set-up-customer-discount-groups.md)
#### [Configuration des vendeurs](sales-how-setup-salespeople.md)
...
#### [Configuration des comptes bancaires fournisseur](purchasing-how-set-up-vendors-bank-accounts.md)
#### [Classement par ordre de priorité des fournisseurs](purchasing-how-prioritize-vendors.md)
...
#### [Enregistrement des nouveaux articles](inventory-how-register-new-items.md)
#### [Copie des articles existants pour créer d’autres articles](inventory-how-copy-items.md)
...
#### [Configuration des unités de gestion de stock](inventory-how-to-set-up-stockkeeping-units.md)
#### [Classement des articles](inventory-how-categorize-items.md)
...
#### [Configuration des informations générales sur les immobilisations](fa-how-setup-general.md)
#### [Configuration de l’amortissement des immobilisations](fa-how-setup-depreciation.md)
#### [Définition des méthodes d’amortissement.](fa-depreciation-methods.md)
#### [Configuration des méthodes d’amortissement définies par l’utilisateur](fa-how-setup-user-defined-depreciation-method.md)
#### [Configuration des assurances sur les immobilisations](fa-how-setup-insurance.md)
#### [Configuration de la maintenance des immobilisations](fa-how-setup-maintenance.md)
### Configuration de la gestion d’entrepôt
#### [Configuration des entrepôts](warehouse-setup-warehouse.md)
#### [Vue d’ensemble de la gestion d’entrepôt](design-details-warehouse-management.md)
#### [Configuration des types d’emplacements](warehouse-how-to-set-up-bin-types.md)
#### [Création d’emplacements](warehouse-how-to-create-individual-bins.md)
#### [Création des contenus d’emplacements](warehouse-how-to-set-up-bin-contents.md)
#### [Affectation des emplacements par défaut à des articles](warehouse-how-to-assign-default-bins-to-items.md)
#### [Configuration des modèles rangement](warehouse-how-to-set-up-put-away-templates.md)
#### [Configuration des magasiniers](warehouse-how-to-set-up-warehouse-employees.md)
#### [Configuration des magasins pour qu’ils utilisent des emplacements](warehouse-how-to-set-up-locations-to-use-bins.md)
#### [Conversion des magasins existants dans les entrepôts](warehouse-how-to-convert-existing-locations-to-warehouse-locations.md)
...
#### [Configuration des articles et des magasins pour prélèvement et rangement suggérés](warehouse-how-to-set-up-items-for-directed-put-away-and-pick.md)
...
#### [Activation de la méthode FEFO pour prélever des articles](warehouse-picking-by-fefo.md)
<!-- #### [Enable Automated Data Capture Systems (ADCS)](warehouse-use-automated-data-capture-systems-adcs.md) -->
#### [Restructuration des entrepôts](warehouse-how-to-restructure-warehouses.md)
### Configuration de la fabrication
#### [Configuration de la fabrication](production-configure-production-processes.md)
#### [Création de calendriers centre de charge](production-how-to-create-work-center-calendars.md)
#### [Configuration des centres de charge et des postes de charge](production-how-to-set-up-work-and-machine-centers.md)
#### [Création des gammes](production-how-to-create-routings.md)
#### [Création des nomenclatures de production](production-how-to-create-production-boms.md)
#### [Activation de la consommation des composants en fonction de la production réalisée](production-how-to-flush-components-according-to-operation-output.md)
#### [Utilisation des unités de mesure de lot de fabrication](production-how-to-use-the-manufacturing-batch-unit-of-measure.md)
#### [Gestion des tailles de lot en production](production-handling-lot-sizes.md)
#### [Utilisation des familles de production](production-how-work-family.md)
#### [Configuration des lignes gamme standard](production-how-set-up-standard-routing-lines.md)
#### [Fabrication en sous-traitance](production-how-to-subcontract-manufacturing.md)
### Configuration de la gestion des services
#### [Configuration de la gestion des services](service-setup-service.md)
#### [Création d’articles service](service-how-to-create-service-items.md)
#### [Configuration des codes prestation standard](service-how-setup-service-coding.md)
...
#### [Configuration des offres de services](service-how-setup-service-offerings.md)
#### [Configuration de la résolution de problèmes](service-how-setup-troubleshooting.md)
#### [Configuration de l’affectation des ressources](service-how-setup-resource-allocation.md)
#### [Configuration de la tarification et des frais supplémentaires pour les services](service-how-setup-service-costs-pricing.md)
#### [Configuration des articles de service et des composants article de service](service-how-setup-service-items.md)
#### [Configuration des heures de travail et des heures de maintenance](service-how-setup-work-service-hours.md)
#### [Configuration les statuts des commandes service et des réparations](service-order-repair-status.md)
#### [Configuration d’un programme d’articles de prêt](service-how-setup-loaner-program.md)
#### [Configuration des contrats de service](service-how-setup-service-contracts.md)
### Configuration des meilleures pratiques pour des domaines d’application complexes 
...
##### [Configuration des meilleures pratiques : paramètres de planification](setup-best-practices-planning-parameters.md)
...
#### [Sélection des états pour les documents](across-report-selections.md)
### Configuration des flux de travail approbation basés sur des modèles
#### [Configuration des flux de travail approbation](across-set-up-workflows.md)
...
#### [Notifications des flux de travail d’approbation](across-setting-up-workflow-notifications.md)
#### [Spécification de la procédure pour recevoir les notifications de flux de travail](across-how-to-specify-when-and-how-to-receive-notifications.md)
#### [Création des flux de travail approbation](across-how-to-create-workflows.md)
#### [Création de flux de travail à partir de modèles de flux de travail](across-how-to-create-workflows-from-workflow-templates.md)
#### [Exportation et importation des flux de travail approbation](across-how-to-export-and-import-workflows.md)
#### [Procédure pas à pas : configuration et utilisation d’un flux de travail approbation achat](walkthrough-setting-up-and-using-a-purchase-approval-workflow.md)
<!--Connectors-->
### Configuration des connexions
#### [Obtention du complément Business Central pour Excel](admin-deploy-excel-addin.md)
...
##### [Accès aux données dans Teams sans licence Business Central](teams-access-with-m365-license.md)
...
##### [FAQ sur Teams](teams-faq.md)
##### [Résolution des problèmes d’intégration de Teams](admin-teams-troubleshooting.md)
#### Utilisation de OneDrive for Business avec Business Central
##### [Vue d’ensemble](across-onedrive-overview.md)
##### [Gestion de l’intégration de OneDrive for Business](admin-onedrive-integration.md)
###### [Configuration de l’intégration OneDrive avec Business Central local](admin-onedrive-integration-onpremises.md)
##### [Ouverture et partage des fichiers dans OneDrive](across-share-onedrive.md)
...
##### Créateur d’états
###### [Démarrage : création d’états](across-how-use-financials-data-source-powerbi.md)
###### [Création des états pour afficher les données de listes](across-how-use-powerbi-reports-factbox.md)
##### Utilisateurs métier
###### [Utilisation des états Power BI dans Business Central](across-working-with-powerbi.md)
...
##### [Utilisation des flux Power Automate dans Business Central](across-how-use-financials-data-source-flow.md)
##### [Résolution des problèmes de flux de travail automatisés](across-flow-troubleshoot.md)  
...
#### [Factures groupées pour Microsoft Bookings](finance-bookings.md)
...
### [Configuration des calendriers de base](across-how-to-assign-base-calendars.md)
### Configuration des imprimantes
#### [Vue d’ensemble](admin-printer-setup-overview.md)
#### [Imprimantes à impression universelle](admin-printer-setup-universal-print.md)
#### [Imprimantes par e-mail](admin-printer-setup-email.md)
#### [Spécification d’une imprimante par défaut](ui-specify-printer-selection-reports.md)
### [Configuration des cartes en ligne](across-online-maps-setup.md)
### [Obtention de Business Central sur votre appareil mobile](install-mobile-app.md)
### [Obtention de Business Central sur votre bureau](install-desktop-app.md)
<!--Reporting landing page-->
# BI et création d’états 

## [Vue d’ensemble](reports-bi-reporting.md)

## Utilisation des états dans le travail quotidien
### [Vue d’ensemble](reports-use-reports.md)
### [Exécution des états](ui-work-report.md)
### [Ajouter un signet à un état](ui-bookmarks.md)
### [Analyse des données d’état avec Excel](report-analyze-excel.md)
### [Impression des états](ui-specify-printer-selection-reports.md#default)
### [Planification des états](ui-work-report.md#ScheduleReport)
### [Partage et exportation des états avec la boîte de réception état](ui-work-report-inbox.md)
### [Gestion des paramètres d’états enregistrés](reports-saving-reusing-settings.md)
### [Définition de la disposition utilisée par un état](ui-set-report-layout.md)
### [(Hérité) Définition de la disposition utilisée par un état](ui-how-change-layout-currently-used-report.md)

## États intégrés
### [Vue d’ensemble des états](reports-available-reports.md)
### Finances
#### [BI financière](bi.md)
#### [Analyse des états financiers avec Excel](finance-analyze-excel.md)
#### [États financiers clés](finance-reports.md)
#### [États Comptabilité client](receivables-reports.md)
#### [États Comptabilité fournisseur](payables-reports.md)
#### [Analyse de trésorerie](finance-setup-cash-flow-analyses.md)
...
### Projet
#### [États de projet](project-reports.md)
#### [Affichage des estimations d’activités de projets](projects-how-record-job-usage.md#to-view-job-usage-estimates-and-post-updates)
#### [Surveillance de la progression et des performances du projet](projects-how-monitor-progress-performance.md)
...
#### [Affichage de la structure de la nomenclature](assembly-how-work-assembly-boms.md#to-view-components-and-resources-indented-according-to-the-bom-structure)

### Fabrication
#### [États de production](production-reports.md)
#### [Affichage de la charge sur les centres de charge et les postes de charge](production-how-to-view-the-load-on-work-centers.md)
...
### [Analyse des états financiers avec Excel](finance-analyze-excel.md)
### [Consolidation des données financières de plusieurs sociétés](finance-consolidated-company-reporting.md)
### [Signalement de l’activité de la télémétrie](/dynamics365/business-central/dev-itpro/administration/telemetry-reports-trace)
...
#### [Types de dispositions (Word, Excel, RDLC)](ui-manage-report-layouts.md)
#### [Création et modifications des dispositions](ui-get-started-layouts.md)
...
#### [Définition de la disposition par défaut](ui-set-report-layout.md)
...
## [Fonctionnalités d’évaluation qui se connectent à d’autres services Microsoft](privacy-connected-services.md)
...
#### [Contrôle de l’accès à Business Central à l’aide de groupes de sécurité](ui-security-groups.md)
#### Accès avec des licences Microsoft 365
...
##### [Résolution des problèmes](admin-access-with-m365-license-troubleshooting.md) 
#### Attribution des autorisations utilisateur
##### [Création des utilisateurs en fonction des licences](ui-how-users-permissions.md)
##### [Affectation d’autorisations aux utilisateurs et aux groupes](ui-define-granular-permissions.md)
### Gestion des préférences client
#### [Gestion des profils](admin-users-profiles-roles.md)
#### [Gestion des paramètres et des préférences client](admin-manage-user-settings-preferences.md)
### Contrôle des données
#### [Classement de la confidentialité des données](admin-classifying-data-sensitivity.md)
...
#### [Gestion du stockage en compressant des données ou en supprimant des documents](admin-manage-documents.md)
#### [Archivage des données](admin-archive-data.md)
...
#### [Affichage des verrouillages de base de données](admin-view-database-locks.md)
...
### [Création de nouvelles sociétés](about-new-company.md)
### [Utilisation des files projets pour planifier des tâches](admin-job-queues-schedule-tasks.md)
### [Publication d’un service web](across-how-publish-web-service.md)
### [Configuration des modèles API](admin-configuring-api-template.md)
### [Extension de votre version d’essai](admin-extend-trial.md)
### [Inspection des pages](across-inspect-page.md)
### [Affichage des informations sur la table](admin-view-table-information.md)
### [Activation des nouvelles fonctionnalités à l’avance](admin-feature-management.md)
### [Intégration des utilisateurs avec des listes de contrôle](admin-checklist.md)
...
### [Configuration d’un indicateur en couleur sur des piles](admin-how-set-up-colored-indicator-on-cues.md)
### Personnalisation avec les extensions
#### [Vue d’ensemble des extensions](ui-extensions.md)
#### [Installation et désinstallation des extensions](ui-extensions-install-uninstall.md)
#### [Extension AMC Banking 365 Fundamentals](ui-extensions-amc-banking.md)
#### [Paie Ceridian](ui-extensions-ceridian-payroll.md)
#### [Hub Entreprise](ui-extensions-company-hub.md)
#### [DK – Migration des données C5](ui-extensions-c5-data-migration.md)
#### [DK – Paiements et rapprochements](ui-extensions-payments-reconciliation-formats-dk.md)
#### [DK – Formats de fichiers fiscaux](ui-extensions-tax-file-formats-dk.md)
#### [Envestnet Yodlee Bank Feeds](ui-extensions-yodlee-bank-feeds.md)
#### [Informations commerciales essentielles](ui-extensions-essential-business-insights.md)
#### [Analyseur d’image](ui-extensions-image-analyzer.md)
#### [Extensions de migration cloud](ui-extensions-data-replication.md)
#### [Base de la migration cloud](ui-extensions-intelligent-cloud.md)
#### [Prédictions de paiements tardifs](ui-extensions-late-payment-prediction.md)
#### [Microsoft Pay](ui-extensions-microsoft-pay-payments.md)
#### [PayPal Payments Standard](ui-extensions-paypal-payments-standard.md)
#### [Migration des données QuickBooks](ui-extensions-quickbooks-data-migration.md)
#### [Migration des données QuickBooks Online](ui-extensions-quickbooks-online-data-migration.md)
#### [Importation du fichier de paie Quickbooks](ui-extensions-quickbooks-payroll.md)
#### [Stock et ventes prévus](ui-extensions-sales-forecast.md)
#### [Extension de déclaration de service](finance-how-setup-use-service-declaration.md)
#### [R.U. – Extension des codes postaux au R.-U. GetAddress.io](LocalFunctionality/UnitedKingdom/ui-extensions-getaddressio.md)
#### [R.-U. – Gestion des groupes TVA](ui-extensions-vat-group.md)
...
## Intégration à d’autres applications Dynamics 365
...
### [Planification d’une synchronisation](admin-scheduled-synchronization-using-the-synchronization-job-queue-entries.md)
...
## Synchronisation des données principales entre les sociétés
...
### [Vue d’ensemble des détails de conception d’application](design-details-application-design.md)
### Détails de conception : planification de l’approvisionnement
#### [Vue d’ensemble de la planification de l’approvisionnement](design-details-supply-planning.md)
#### [Détails de conception : concepts centraux du système de planification](design-details-central-concepts-of-the-planning-system.md)  
#### [Détails de conception : réservation, chaînage et messages d’action](design-details-reservation-order-tracking-and-action-messaging.md)  
#### [Détails de conception : équilibrage de la demande et de l’approvisionnement](design-details-balancing-demand-and-supply.md)  
#### [Détails de conception : gestion des méthodes de réapprovisionnement](design-details-handling-reordering-policies.md)  
#### [Détails de conception : paramètres de plan](design-details-planning-parameters.md)  
#### [Détails de conception : table d’affectation de plan](design-details-planning-assignment-table.md)  
#### [Détails de conception : transferts de planification](design-details-transfers-in-planning.md)
### Détails de conception : évaluation des coûts de stock
#### [Vue d’ensemble de l’évaluation des coûts](design-details-inventory-costing.md)
#### [Détails de conception : méthodes d’évaluation des coûts](design-details-costing-methods.md)  
#### [Détails de conception : modification de la méthode d’évaluation des coûts pour les articles](design-details-changing-costing-methods.md)
#### [Détails de conception : lettrage article](design-details-item-application.md)  
#### [Détails de conception : problème de lettrage article connu](design-details-inventory-zero-level-open-item-ledger-entries.md)  
...
### [Gestion de la migration vers le cloud](/dynamics365/business-central/dev-itpro/administration/migration-manage?toc=/dynamics365/business-central/toc.json)
### [Migration depuis Business Central local](/dynamics365/business-central/dev-itpro/administration/migrate-business-central-on-premises?toc=/dynamics365/business-central/toc.json)
...
### [FAQ sur la migration vers le cloud](/dynamics365/business-central/dev-itpro/administration/faq-migrate-data?toc=/dynamics365/business-central/toc.json)
## [Administration de Business Central Online](/dynamics365/business-central/dev-itpro/administration/tenant-administration?toc=/dynamics365/business-central/toc.json)
