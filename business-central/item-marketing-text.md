...
# <a name="add-marketing-text-to-items" />Ajouter du texte marketing aux articles
...
### <a name="create-first-draft-with-copilot" />Créer un premier brouillon avec Copilot
...
### <a name="review-edit-and-save-text" />Vérifier, modifier et enregistrer le texte
...
### <a name="improve-and-tailor-text-suggestions" />Améliorez et personnalisez les suggestions de texte
...
## <a name="create-marketing-text-from-scratch" />Créer un texte marketing à partir de zéro
