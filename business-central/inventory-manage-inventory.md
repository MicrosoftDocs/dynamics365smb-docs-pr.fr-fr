...
|Créer des fiches article spéciales pour les articles que vous proposez aux clients, mais que vous n'avez pas en stock.|[Utiliser des articles non stockés](inventory-how-work-nonstock-items.md)|
