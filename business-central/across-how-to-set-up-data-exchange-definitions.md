...
### <a name="to-map-columns-in-the-data-file-to-fields-in-prod_short"></a><a name=mapfields></a>Pour mapper les colonnes du fichier de données aux champs de [!INCLUDE[prod_short](includes/prod_short.md)]
...
À partir de la deuxième vague de lancement 2022, vous pouvez également opérer un regroupement par n’importe quel champ, utiliser l’index clé pour trier les résultats et les nouveaux types de transformation **Arrondi** et **Recherche de champ**.
