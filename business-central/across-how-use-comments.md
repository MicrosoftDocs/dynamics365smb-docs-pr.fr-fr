...
La plupart des fiches et documents ont une action **Commentaires**, qui ouvre la fenêtre **Feuille de commentaires** dans laquelle vous pouvez saisir ou lire les commentaires. Sur les documents, vous pouvez également ajouter des commentaires à différentes lignes.
...
4. Dans la fenêtre **Feuille de commentaires**, vous pouvez saisir le texte, puis choisir le bouton **OK**.
