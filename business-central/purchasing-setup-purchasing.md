...
ms.author: edupont
---
# <a name="setting-up-purchasing" />Définition des achats
...
## <a name="purchases-and-payables-setup" />Paramètres achats
...
### <a name="general-settings" />Paramètres généraux
...
### <a name="number-series-settings" />Paramètres de souches de numéros
...
## <a name="exact-cost-reversing" />Inversion de même coût
...
## <a name="more-purchasing-setups" />Plus de configurations d’achat
