...
ms.author: edupont
---
# <a name="work-with-blanket-sales-orders-or-blanket-purchase-orders" />Utiliser des Commandes cadres vente ou des commandes cadres achat
...
## <a name="to-create-a-blanket-sales-order" />Pour créer une commande vente ouverte.
...
## <a name="to-create-a-sales-order-from-a-blanket-sales-order" />Pour créer une commande vente à partir d’une commande ouverte vente
...
## <a name="to-view-the-status-of-a-blanket-sales-order" />Pour visualiser le statut d’une commande ouvertes vente
...
## <a name="to-view-unposted-and-posted-blanket-sales-order-lines" />Pour afficher des lignes de commande vente ouverte non validées et validées
