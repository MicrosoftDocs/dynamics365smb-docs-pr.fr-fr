...
#### Approche 1 : Exporter la présentation à partir de la page **Présentations d’état**
...
#### Approche 2 : Téléchargez la présentation à partir de la page de demande de l’état
...
|N°|Élément|Désignation|Obligatoire|
|---|-------|----|---|
