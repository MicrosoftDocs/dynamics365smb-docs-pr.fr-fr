...
ms.author: edupont
---
# <a name="year-end-processes-overview-in-the-french-version"></a><a name="year-end-processes-overview-in-the-french-version"></a>Vue d’ensemble des processus de fin d’année dans la version française
