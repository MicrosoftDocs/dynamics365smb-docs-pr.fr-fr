...
ms.author: edupont
---
# <a name="create-payment-slips" />Créer bordereaux paiement
...
## <a name="to-create-a-payment-slip-for-vendors" />Pour créer un bordereau de paiement pour les fournisseurs
...
## <a name="to-create-a-payment-file" />Pour créer un fichier de paiement
