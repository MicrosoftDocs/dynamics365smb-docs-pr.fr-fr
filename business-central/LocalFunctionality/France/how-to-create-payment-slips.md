...
ms.author: edupont
---
# <a name="create-payment-slips"></a><a name="create-payment-slips"></a>Créer bordereaux paiement
...
## <a name="to-create-a-payment-slip-for-vendors"></a><a name="to-create-a-payment-slip-for-vendors"></a>Pour créer un bordereau de paiement pour les fournisseurs
...
## <a name="to-create-a-payment-file"></a><a name="to-create-a-payment-file"></a>Pour créer un fichier de paiement
