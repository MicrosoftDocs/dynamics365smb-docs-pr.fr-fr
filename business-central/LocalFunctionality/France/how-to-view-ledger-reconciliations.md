...
ms.author: edupont
---
# <a name="view-ledger-reconciliations"></a><a name="view-ledger-reconciliations"></a><a name="view-ledger-reconciliations"></a>Afficher des rapprochements comptables
...
## <a name="to-view-general-ledger-reconciliation-with-the-customer-ledger"></a><a name="to-view-general-ledger-reconciliation-with-the-customer-ledger"></a><a name="to-view-general-ledger-reconciliation-with-the-customer-ledger"></a>Pour afficher le rapprochement des écritures comptables avec les écritures comptables client
