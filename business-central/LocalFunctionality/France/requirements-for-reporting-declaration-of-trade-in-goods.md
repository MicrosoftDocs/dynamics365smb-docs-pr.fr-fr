...
ms.author: edupont
---
# <a name="requirements-for-reporting-declaration-of-trade-in-goods-in-the-french-version" />Configuration requise pour la déclaration d’échanges de biens dans la version française
...
## <a name="intrastat-requirements-for-deb" />Configuration requise en matière d’état communautaire pour DEB
...
## <a name="validate-intrastat-lines" />Valider les lignes intracommunautaires
...
### <a name="to-enable-the-check" />Pour activer la vérification
