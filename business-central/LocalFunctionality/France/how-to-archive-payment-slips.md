...
ms.author: edupont
---
# <a name="archive-payment-slips-in-the-french-version" />Archiver les bordereaux de paiement dans la version française
...
## <a name="to-archive-a-payment-slip" />Pour archiver un bordereau paiement
...
## <a name="to-archive-a-batch-of-payment-slips" />Pour archiver un lot de bordereaux paiement
