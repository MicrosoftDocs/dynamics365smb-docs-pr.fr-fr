...
ms.author: edupont
---
# <a name="close-years-in-the-french-version"></a><a name="close-years-in-the-french-version"></a><a name="close-years-in-the-french-version"></a>Clôturer les exercices dans la version française
Lorsqu’un exercice comptable est terminé, vous devez clôturer les périodes qui le composent.  

## <a name="to-close-a-year"></a><a name="to-close-a-year"></a><a name="to-close-a-year"></a>Pour clôturer un exercice
