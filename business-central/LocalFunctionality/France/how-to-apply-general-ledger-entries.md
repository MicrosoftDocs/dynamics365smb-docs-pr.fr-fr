...
ms.author: bholtorf
---
# <a name="apply-general-ledger-entries-in-the-french-version"></a><a name="apply-general-ledger-entries-in-the-french-version"></a>Appliquer les écritures comptables dans la version française
