...
ms.author: edupont
---
# <a name="post-payment-slips-in-the-french-version" />Valider les bordereaux de paiement dans la version française
...
## <a name="to-post-a-payment-slip" />Pour valider un bordereau paiement
