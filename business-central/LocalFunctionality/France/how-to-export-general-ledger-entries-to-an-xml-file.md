...
ms.author: edupont
---
# <a name="export-general-ledger-entries-to-an-xml-file"></a><a name="export-general-ledger-entries-to-an-xml-file"></a><a name="export-general-ledger-entries-to-an-xml-file"></a>Exporter des écritures comptables vers un fichier XML
...
## <a name="to-export-general-ledger-entries-to-an-xml-file"></a><a name="to-export-general-ledger-entries-to-an-xml-file"></a><a name="to-export-general-ledger-entries-to-an-xml-file"></a>Pour exporter des écritures comptables vers un fichier XML
