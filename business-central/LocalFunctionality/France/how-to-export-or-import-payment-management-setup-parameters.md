...
ms.author: edupont
---
# <a name="export-or-import-payment-management-setup-parameters" />Exporter ou importer les paramètres de configuration de la gestion des paiements
...
## <a name="to-export-or-import-payment-management-setup-parameters" />Pour exporter ou importer les paramètres de configuration de la gestion des paiements
