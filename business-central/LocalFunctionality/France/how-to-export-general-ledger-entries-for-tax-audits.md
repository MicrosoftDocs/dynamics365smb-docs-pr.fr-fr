...
ms.author: edupont
---
# <a name="export-general-ledger-entries-for-tax-audits-in-the-french-version" />Exporter les écritures comptables pour les contrôles fiscaux en version française
...
## <a name="to-export-general-ledger-entries-to-a-text-file-for-a-tax-audit" />Pour exporter des écritures comptables ver un fichier texte pour un audit fiscal
