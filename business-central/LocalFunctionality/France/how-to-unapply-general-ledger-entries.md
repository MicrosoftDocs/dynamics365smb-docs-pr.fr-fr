...
ms.author: edupont
---
# <a name="unapply-general-ledger-entries-in-the-french-version" />Délettrer les écritures comptables dans la version française
Vous pouvez délettrer des écritures comptables de manière très directe.  

## <a name="to-unapply-general-ledger-entries" />Pour délettrer des écritures comptables
