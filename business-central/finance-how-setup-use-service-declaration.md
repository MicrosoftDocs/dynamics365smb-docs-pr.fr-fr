...
---
# <a name="the-service-declaration-extension" />Extension de déclaration de service
...
## <a name="enable-the-service-declaration-extension" />Activer l’extension de déclaration de service
...
## <a name="set-up-the-service-declaration-extension" />Configurer l’extension de déclaration de service
...
### <a name="to-set-up-service-declaration-manually" />Pour configurer de la déclaration de service manuellement
...
### <a name="item-charges" />Frais annexes
...
## <a name="create-new-service-declaration" />Créer une déclaration de service
...
## <a name="modify-a-service-declaration" />Modifier une déclaration de service
...
## <a name="overview-the-service-declaration-lines" />Présentation des lignes de déclaration de service
...
## <a name="report-service-declaration-in-a-file" />Faire figurer la déclaration de service dans un fichier
...
## <a name="other-considerations" />Autres considérations
...
### <a name="grouping-lines" />Regrouper des lignes
...
### <a name="using-services-in-document-lines" />Utilisation des services dans les lignes de document
