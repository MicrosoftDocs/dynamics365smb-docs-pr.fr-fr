...
---
# <a name="design-details-handling-reordering-policies" />Détails de conception : gestion des méthodes de réapprovisionnement
...
## <a name="the-role-of-the-reorder-point" />Le rôle du point de commande
...
## <a name="monitoring-the-projected-inventory-level-and-the-reorder-point" />Surveillance du niveau de stock prévisionnel et du point de commande
...
### <a name="projected-inventory" />Stock projeté
...
### <a name="projected-available-inventory" />Stock disponible projeté
...
### <a name="time-buckets" />Intervalles de planification
...
### <a name="determining-the-projected-inventory-level" />Déterminer le niveau de stock prévisionnel
...
## <a name="the-role-of-the-time-bucket" />Le rôle de l’intervalle de planification
...
## <a name="stay-below-the-overflow-level" />Rester sous le niveau de dépassement de capacité
...
### <a name="calculating-the-overflow-level" />Calcul du niveau de dépassement de capacité
...
#### <a name="maximum-qty" />Qté maximum
...
#### <a name="fixed-reorder-qty" />Qté fixe de commande.
...
#### <a name="order-multiple" />Commandé par ;
...
### <a name="creating-the-planning-line-with-an-overflow-warning" />Création de la ligne planning avec un avertissement de dépassement capacité
...
#### <a name="calculating-the-planning-line-quantity" />Calcul de la quantité pour la ligne planning
...
#### <a name="defining-the-action-message-type" />Définir le type de message d’action
...
#### <a name="composing-the-warning-message" />Composition du message d’avertissement
...
### <a name="example-scenario" />Exemple de scénario
...
#### <a name="item-setup" />Paramétrage de l’article
...
#### <a name="situation-before-sales-decrease" />Situation avant la sortie de vente
...
#### <a name="situation-after-sales-decrease" />Situation après la sortie de vente
...
#### <a name="resulting-planning-lines" />Lignes planning résultantes
...
## <a name="handling-projected-negative-inventory" />Traitement du stock prévisionnel négatif
...
### <a name="fixed-reorder-quantity" />Qté fixe de commande
...
#### <a name="calculated-per-time-bucket" />Calculé par intervalle de planification
...
#### <a name="creates-only-necessary-supply" />Crée uniquement l’approvisionnement nécessaire
...
#### <a name="combines-with-order-modifiers" />Associe avec les modificateurs de commande
...
#### <a name="combines-with-calendars" />Associe avec des calendriers
...
#### <a name="shouldnt-be-used-with-forecasts" />Ne doit pas être utilisé avec les prévisions
...
#### <a name="must-not-be-used-with-reservations" />Ne doit pas être utilisé avec les réservations
...
### <a name="maximum-quantity" />Quantité maximale
...
#### <a name="calculate-per-time-bucket" />Calculer par intervalle de planification
...
#### <a name="combine-with-order-modifiers" />Associe avec les modificateurs de commande
...
### <a name="combine-with-calendars" />Combinaison avec des calendriers
...
#### <a name="order-to-order-links-and-past-due-dates" />Liens ordre pour ordre et dates arriérées
...
### <a name="lot-for-lot" />Lot pour lot
