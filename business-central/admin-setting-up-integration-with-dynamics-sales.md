...
ms.author: bholtorf
---
# <a name="setting-up-user-accounts-for-integrating-with-microsoft-dataverse" />Configuration des comptes d’utilisateur pour intégration à Microsoft Dataverse
...
## <a name="set-up-the-administrator-user-account" />Configuration du compte d’utilisateur administrateur
...
## <a name="permissions-and-security-roles-for-user-accounts-in-includeprodshortincludescdslongmdmd" />Autorisations et rôles de sécurité pour les comptes d’utilisateur dans [!INCLUDE[prod_short](includes/cds_long_md.md)]
