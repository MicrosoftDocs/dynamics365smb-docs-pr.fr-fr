...
## <a name="setting-up-accounts-for-salespeople"></a>Configuration des comptes pour les vendeurs
...
## <a name="minimum-permissions-for-user-accounts-in-crm_md"></a>Autorisations minimales pour les comptes d'utilisateurs dans [!INCLUDE[crm_md](includes/crm_md.md)]
