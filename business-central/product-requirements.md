...
---
# <a name="minimum-requirements-for-using-business-central" />Configuration minimale requise pour l’utilisation de Business Central
...
## <a name="mobile-devices" />Périphériques mobiles
...
## <a name="use-business-central-on-premises" />Utiliser Business Central sur site
