...
ms.author: bholtorf
---
# <a name="design-details-average-cost" />Détails de conception : coût moyen
...
## <a name="setting-up-average-cost-calculation" />Configuration du calcul du coût moyen
...
## <a name="calculating-average-cost" />Calcul du coût moyen
...
### <a name="example-average-cost-period--day" />Exemple : période coût moyen = jour
...
### <a name="example-average-cost-period--month" />Exemple : période coût moyen = mois
...
## <a name="setting-the-valuation-date" />Définition de la date d’évaluation
...
## <a name="recalculating-average-cost" />Recalcul du coût moyen
...
### <a name="example-of-recalculated-average-cost" />Exemple de coût moyen recalculé
