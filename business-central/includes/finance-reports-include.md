...
|[Balance consolidée](https://businesscentral.dynamics.com?report=10007)|Affiche un aperçu combiné des écritures comptables pour deux sociétés ou plus dans une société consolidée. Utilisez ce rapport pour générer des rapports sur les données financières consolidées de plusieurs sociétés. Pour plus d’informations, voir [Configurer la consolidation de la société](../finance-consolidated-company-reporting-setup.md)|17|
|[Balance consolidée (4 stés)](https://businesscentral.dynamics.com?report=10008)|Affiche un aperçu combiné des écritures comptables pour deux sociétés ou plus dans une société consolidée. Cette version du rapport vous permet d’afficher jusqu’à quatre centres de profit sous forme de colonnes. Pour plus d’informations, voir [Configurer la consolidation de la société](../finance-consolidated-company-reporting-setup.md). Utilisez ce rapport pour générer des rapports sur les données financières consolidées de plusieurs sociétés.|18|
