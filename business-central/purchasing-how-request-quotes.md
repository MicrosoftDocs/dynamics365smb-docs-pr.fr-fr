...
## <a name="create-a-purchase-quote"></a>Créer une demande de prix
...
## <a name="convert-a-purchase-quote-to-a-purchase-order"></a>Convertir une demande de prix en commande achat
