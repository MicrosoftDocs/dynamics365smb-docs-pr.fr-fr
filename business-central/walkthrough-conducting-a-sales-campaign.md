...
description: Cette procédure pas à pas donne un aperçu détaillé de toutes les tâches impliquées dans la conduite d’une campagne de vente dans Business Central.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
6. Dans le champ **Sujet (par défaut)**, entrez le texte exemple suivant : **Merci de votre visite au salon**. Appuyez sur la touche de tabulation pour quitter le champ et sélectionnez le bouton **Oui**.
