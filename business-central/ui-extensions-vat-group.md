...
4. Dans le champ **Compte de déclaration de groupe**, spécifiez le compte de déclaration utilisé pour les montants de TVA du membre du groupe.
5. Dans le champ **Compte déclaration de TVA**, spécifiez le compte que vous utilisez pour les déclarations de TVA.
