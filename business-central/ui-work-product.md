...
| À | Voir |
| --- | --- |
| Recherchez une page, un état, une action, une rubrique d'aide, ou une extension partenaire. |[Utilisation de la fonction Tell Me pour trouver des fonctions et des informations](ui-search.md) |
...
|Découvrez comment rapidement copier et coller des données y compris à l'aide des raccourcis clavier.|[Copier et coller](ui-copy-paste.md)|
...
| Modifier les champs et les actions affichés dans l'interface utilisateur pour correspondre aux processus entreprise de votre société. |[Personnalisation de [!INCLUDE[d365fin](includes/d365fin_md.md)]](ui-customizing-overview.md) |
|Définissez, obtenez un aperçu, imprimez, ou enregistrez les états et définissez et exécutez des traitements par lots.|[Utilisation des états et des traitements par lots](ui-work-report.md)|
