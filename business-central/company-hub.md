...
# <a name="manage-work-across-multiple-companies-in-the-company-hub" />Gérer le travail entre plusieurs entreprises dans le Hub Entreprise
...
## <a name="company-hub-home-page" />Page d’accueil du Hub Entreprise
...
## <a name="assigned-tasks" />Tâches affectées
...
### <a name="my-user-tasks" />Mes tâches utilisateur
...
## <a name="access-the-company-hub" />Accéder au Hub Entreprise
...
## <a name="set-up-the-company-hub" />Configurer le Hub Entreprise
