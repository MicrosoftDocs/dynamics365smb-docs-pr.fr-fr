...
# <a name="manage-work-across-multiple-companies-in-the-company-hub"></a><a name="manage-work-across-multiple-companies-in-the-company-hub"></a>Gérer le travail entre plusieurs entreprises dans le Hub Entreprise
...
## <a name="company-hub-home-page"></a><a name="company-hub-home-page"></a>Page d’accueil du Hub Entreprise
...
## <a name="assigned-tasks"></a><a name="assigned-tasks"></a>Tâches affectées
...
### <a name="my-user-tasks"></a><a name="my-user-tasks"></a>Mes tâches utilisateur
...
## <a name="access-the-company-hub"></a><a name="access-the-company-hub"></a>Accéder au Hub Entreprise
...
## <a name="set-up-the-company-hub"></a><a name="set-up-the-company-hub"></a>Configurer le Hub Entreprise
