...
description: "Décrit comment configurer les processus de stock, tels que des magasins et des acheminements transfert."
...
Lorsque vous avez configuré votre stock, vous pouvez gérer différents processus de stock. Pour plus d'informations, reportez-vous à [Gestion du stock](inventory-manage-inventory.md).  

| Pour | Voir |
| --- | --- |
| Définissez la configuration générale de stock, telles que la souche de numéros et comment utiliser des magasins. |[Procédure : définir des informations générales relatives aux stocks](inventory-how-setup-general.md) |
| Planifiez votre stock dans plusieurs magasins, y compris des acheminements transfert. |[Procédure : configurer des magasins](inventory-how-register-new-items.md) |
