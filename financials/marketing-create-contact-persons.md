---
title: "Personnes à contacter | Microsoft Docs"
description: "Vous pouvez créer des personnes à contacter à partir de sociétés contact existantes ou des personnes contact indépendantes dans Financials."
...
---
# <a name="contact-persons"></a>Personnes à contacter
...
| Décrire la relation d'affaires d'un contact société. |[Configuration des responsabilités sur les contacts](marketing-job-responsibilities.md) |
| Décrire le niveau hiérarchique de vos contacts. |[Configuration des niveaux hiérarchiques pour les personnes à contacter](marketing-organizational-levels.md) |
