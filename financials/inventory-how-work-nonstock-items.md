---
title: "Procédure : utiliser des articles non stockés| Microsoft Docs"
description: "Décrit comment commercialiser les articles non maintenus en stock"
documentationcenter: 
author: SorenGP
...
1. Dans le coin supérieur droit, sélectionnez l'icône **Page ou état pour la recherche** ![Page ou état pour la recherche](media/ui-search/search_small.png "Icône Page ou état pour la recherche"), entrez **Articles non stockés**, puis sélectionnez le lien associé.
...
1. Dans le coin supérieur droit, sélectionnez l'icône **Page ou état pour la recherche** ![Page ou état pour la recherche](media/ui-search/search_small.png "Icône Page ou état pour la recherche"), entrez **Paramètres art. non stockés**, puis sélectionnez le lien associé.
...
1. Dans le coin supérieur droit, sélectionnez l'icône **Page ou état pour la recherche** ![Page ou état pour la recherche](media/ui-search/search_small.png "Icône Page ou état pour la recherche"), entrez **Commandes vente**, puis sélectionnez le lien associé.
