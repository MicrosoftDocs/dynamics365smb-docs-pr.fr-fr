---
title: "Procédure : vendre des produits| Microsoft Docs"
description: "Décrit l&quot;utilisation des commandes vente."
...
Les articles peuvent être des articles en stock et des services, représentés par les types **Article - Stock** et **Article - Service** sur les lignes vente. Le processus de commande vente est identique pour les deux types d'article. Pour plus d'informations, reportez vous à [Procédure : enregistrer de nouveaux articles](inventory-how-register-new-items.md).
