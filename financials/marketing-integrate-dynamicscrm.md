...
description: "Vous pouvez utiliser Dynamics 365 for Sales depuis Finance and Operations, Business edition pour mapper les données et avoir une intégration et une synchronisation parfaites dans le processus allant du prospect à l'encaissement."
documentationcenter: 
author: edupont04
...
Pour plus d'informations, voir [Créer des utilisateurs et attribuer des rôles de sécurité Microsoft Finance and Operations, Business edition (en ligne)](https://technet.microsoft.com/library/jj191623.aspx) sur techNet et [Gérer les utilisateurs et les autorisations](ui-how-users-permissions.md).  
...
[Intégrer l'organisation et les utilisateurs dans Finance and Operations, Business edition (en ligne)](https://www.microsoft.com/en-US/Dynamics/crm-customer-center/onboard-your-organization-and-users-to-dynamics-365-online.aspx)  
