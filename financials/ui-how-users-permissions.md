---
title: "Procédure : gérer les utilisateurs et les autorisations | Microsoft Docs"
description: "Gérer les ensembles d&quot;autorisations après avoir créé des utilisateurs dans Office 365."
...
**Important** : si la base de données a plusieurs sociétés, alors au moins un utilisateur doit être membre du groupe d'utilisateurs SUPER dans toutes les sociétés.
...
1. Dans le coin supérieur droit, sélectionnez l'icône Page ou état pour la recherche, entrez **Utilisateurs**, puis sélectionnez le lien connexe.
...
1. Dans le coin supérieur droit, sélectionnez l'icône Page ou état pour la recherche, entrez **Groupes d'utilisateurs**, puis sélectionnez le lien connexe.
