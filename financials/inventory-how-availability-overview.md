---
title: "Procédure : Obtenir un aperçu des disponibilités| Microsoft Docs"
description: "Décrit comment afficher la disponibilité des articles dans tous les magasins, par événement de vente ou d&quot;achat, par période ou par position de l&quot;article sur une nomenclature d&quot;assemblage."
documentationcenter: 
author: SorenGP
...
---
# <a name="how-to-get-an-availability-overview"></a>Procédure : Obtenir un aperçu des disponibilités
...
**Remarque** : ** Les vues de disponibilité par magasin nécessitent la mise à jour de stock dans plusieurs magasins. Pour plus d'informations, reportez-vous à [Procédure : Configurer des magasins](inventory-how-setup-locations.md).
...
**Astuce** : Le stock prévisionnel disponible s'avère particulièrement utile dans les fenêtres **Disponibilité art. par période** et **Disponibilité article par événement** car ils contiennent l'axe de date.  

**Remarque** : Les procédures suivantes décrivent comment afficher des informations avancées sur la disponibilité de la liste des articles et de la fiche article. Vous pouvez également accéder aux informations à partir des lignes de document vente, pour l'article sur la ligne. Pour en savoir plus, voir [Procédure : vendre des produits](sales-how-sell-products.md).
