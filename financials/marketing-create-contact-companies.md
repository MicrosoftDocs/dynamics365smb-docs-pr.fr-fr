---
title: "Création de sociétés contact | Microsoft Docs"
...
| Placer une société contact dans le secteur d'activité approprié, par exemple, la vente au détail. |[Configuration des secteurs d'activité sur des sociétés contact](marketing-industry-groups.md) |
...
| Affecter des recherches Web (moteurs de recherche et sites Web) à vos contacts pour indiquer la zone d'Internet dans laquelle vous souhaitez rechercher des données sur les contacts. |[Configuration des recherches Web sur des contacts](marketing-web-sources.md) |
